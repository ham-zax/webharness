...
2. Use the stateful start/tick/state/stop path on Wikipedia with a search-and-open goal, require the destination article plus `required_operations: ["TYPE_TEXT"]`, tick until verified `done`, and stop the run.
